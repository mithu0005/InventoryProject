...
<a href="http://localhost/SoftDelete/admin/product"
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('admin/product') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" name="quantity" value="{{ old('quantity') }}" required>
